...
const linguisticAgentNodes: TurnOrganizationAgent[] = [
  {
    ...
    accessLevel: 'operational-readonly', procedure: 'CATALOG AUDIT → OIDC/M2M PUBLISHER → TYPED V1 STATE → TURN OBSERVER; fără publicare Browser sau modificare automată de text.',
    escalationLevel: 'L2', subordinateAgentIds: [],
  },
  {
