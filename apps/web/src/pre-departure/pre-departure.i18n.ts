...
export type PreDepartureLanguage = 'ro' | 'de' | 'en' | 'fr' | 'nl' | 'ru' | 'pl' | 'tr' | 'sq' | 'it' | 'es' | 'sv';

export const preDepartureLanguages: readonly PreDepartureLanguage[] = ['ro', 'de', 'en', 'fr', 'nl', 'ru', 'pl', 'tr', 'sq', 'it', 'es', 'sv'];
...
const additionalPreDepartureCopy: Record<Exclude<PreDepartureLanguage, 'ro' | 'de' | 'en'>, PreDepartureCopy> = {
  it: finalLanguageOperationalDictionary.it.preDeparture,
  es: finalLanguageOperationalDictionary.es.preDeparture,
  sv: finalLanguageOperationalDictionary.sv.preDeparture,
