...
export const shellRouteRegistry: readonly ShellRouteDefinition[] = [
  ...
  { view: 'legal', canonicalRoute: '/legal', aliases: ['legal', 'terms', 'privacy', 'compliance', 'knowledge/legislatie', 'knowledge/tahograf', 'knowledge/martori-bord', 'knowledge/ancorarea-marfii'] },
