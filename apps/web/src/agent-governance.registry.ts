...
export const agentGovernanceRegistry: AgentGovernanceRecord[] = [
  ...
  {
    id: 'architecture-guardian', code: 'ARCHITECTURE-GUARDIAN', nameKey: 'agentRegistry.codex.name', roleKey: 'agentRegistry.codex.role', responsibilitiesKey: 'agentRegistry.codex.responsibilities', ownerDepartmentId: 'architecture-platform', status: 'active', lastValidationKey: 'agentRegistry.codex.validation', lastActivityKey: 'agentRegistry.codex.activity', reliabilityKey: 'agentRegistry.reliability.validated', displayName: 'Architecture Guardian', displayRole: 'Architecture boundaries & platform inspection', displayResponsibilities: 'Verifies boundaries, contracts, dependencies and reusable foundations; issues architecture PASS/NO-GO without implementing or validating its own change.',
  },
  {
  ...
  },
  {
    ...
    displayResponsibilities: 'Validează exclusiv pachetul italian în APP, Premium și Car Mover prin Operational Linguistic Baseline V1; observă starea tipizată a celor 1.726 de resurse.',
  },
  {
    ...
    displayResponsibilities: 'Validează exclusiv pachetul spaniol în APP, Premium și Car Mover prin Operational Linguistic Baseline V1; observă starea tipizată a celor 1.726 de resurse.',
  },
  {
    ...
    displayResponsibilities: 'Validează exclusiv pachetul suedez în APP, Premium și Car Mover prin Operational Linguistic Baseline V1; observă starea tipizată a celor 1.726 de resurse.',
  },
  {
