...
function historicalIncidents(): OperationalIncident[] {
  ...
  return [
    ...
    {
      id: 'AGM-FU-20260725-CF1033', occurredAt: '2026-07-25T14:45:00.000Z', updatedAt: '2026-07-25T14:45:00.000Z',
      ...
      attemptedSolutions: 'DNS, TLS, Hetzner și accesul VPS au fost verificate independent.', appliedSolution: '',
      owner: 'Release & Operations', fixedInVersion: '', tests: 'Hetzner Running; TCP/22 accesibil; Cloudflare 1033 reproductibil.',
      humanValidation: 'Follow-up separat; nu afectează API-ul public activ.',
      preventiveMeasure: 'Monitorizarea conectorilor și retragerea hostname-urilor neutilizate.', status: 'remediation',
      relatedIncidentIds: ['AGM_INTEGRITY_AUDIT_2026-07-25'], reusableSolution: false,
      history: [{ at: '2026-07-25T14:45:00.000Z', action: 'transferred', actor: 'Inspector', toStatus: 'remediation', note: 'Transferat din incidentul principal.' }],
    },
    {
      id: 'AGM-FU-20260725-UILIVE', occurredAt: '2026-07-25T14:45:00.000Z', updatedAt: '2026-07-25T14:45:00.000Z',
      ...
      cause: 'Canalele de instrumentare nu au fost disponibile.', attemptedSolutions: 'Builduri, paritate asset, regresii și confirmare umană.',
      appliedSolution: '', owner: 'Frontend Experience / QA & Validation', fixedInVersion: '',
      tests: 'Browser build PASS; Android sync/APK PASS; paritate 17/17; regresii PASS.',
      humanValidation: 'Utilizatorul a confirmat funcționarea aplicației Android și Browser.',
      preventiveMeasure: 'Smoke test instrumentat și captură înaintea următorului release.', status: 'ready-test',
      relatedIncidentIds: ['AGM_INTEGRITY_AUDIT_2026-07-25'], reusableSolution: false,
      history: [{ at: '2026-07-25T14:45:00.000Z', action: 'transferred', actor: 'Inspector', toStatus: 'ready-test', note: 'Transferat pentru probă instrumentată separată.' }],
    },
...
const labels: Record<UiLanguage, JournalLabels> = {
