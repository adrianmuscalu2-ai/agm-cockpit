...
function historicalIncidents(): OperationalIncident[] {
  ...
  return [
    ...
    {
      id: 'AGM-FU-20260725-UILIVE', occurredAt: '2026-07-25T14:45:00.000Z', updatedAt: '2026-07-25T14:56:30.000Z',
      ...
      tests: 'Browser build PASS; Android sync/APK PASS; paritate 17/17; regresii PASS; ADB server healthy, dar 0 targets; Browser Runtime 0 instanțe.',
      humanValidation: 'Fotografiile utilizatorului confirmă website, Turn și o traducere Android funcțională; nu sunt declarate capturi automate.',
