...
export const app009StorageRegistry = [
  ...
  entry('incidentJournal', 'agm.turn.incident-journal.v1', 'OPS-003', 'local', 'operational', true),
  ...
  entry('authAccessToken', 'agm.auth.accessToken', 'API-003', 'local-or-session', 'credential', false),
  entry('preDepartureSession', 'agm.e6.pre-departure.session.v1', 'APP-001', 'local', 'operational', true),
  entry('preDepartureSyncMeta', 'agm.pre-departure.sync-meta.v1', 'APP-001', 'local', 'operational', true),
  entry('preDepartureOutbox', 'agm.pre-departure.outbox.v1', 'APP-001', 'local', 'operational', true),
  entry('preDepartureSyncAck', 'agm.pre-departure.sync-ack.v1', 'APP-001', 'local', 'operational', true),
  ...
  entry('premiumDeviceId', 'agm.premium.device-id.v1', 'PREMIUM', 'local', 'operational', true),
  entry('premiumTripContext', 'agm.premium.trip-context.v1', 'PREMIUM', 'local', 'operational', true),
  entry('premiumOperationalEvents', 'agm.premium.operational-events.v1', 'PREMIUM', 'local', 'operational', true),
  entry('premiumOperationalOutbox', 'agm.premium.operational-outbox.v1', 'PREMIUM', 'local', 'operational', true),
