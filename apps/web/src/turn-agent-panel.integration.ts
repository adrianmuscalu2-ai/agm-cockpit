...
export const panelAgentSources: PanelSource[] = [
  ...
  { panelAgentId: 'monitor-android', displayName: 'Agent Monitorizare Android', displayLevel: 2, department: 'Departamentul de Monitorizare', responsibility: 'Monitorizare Android', escalation: 'L1', turnAgentId: 'monitor-android', sourceId: 'android', telemetrySource: 'Collector Android · neconfigurat' },
  ...
  { panelAgentId: 'architecture-guardian', displayName: 'Architecture Guardian', displayLevel: 3, department: 'Architecture & Platform', responsibility: 'Integritate arhitectură', escalation: 'L2', turnAgentId: 'architecture-guardian' },
