...
const premiumGovernanceAgentIds = new Set([
  'premium-linguist-it', 'premium-linguist-es', 'premium-linguist-sv',
]);
...
export const panelAgentSources: PanelSource[] = [
  ...
  { panelAgentId: 'premium-linguist-it', displayName: 'Italian Language Agent', displayLevel: 3, department: 'i18n', responsibility: 'Validare operațională IT', escalation: 'L2', turnAgentId: 'premium-linguist-it', sourceId: 'premium-linguist-it', telemetrySource: 'Operational Linguistic Baseline V1 · typed API state · 1.726 resurse' },
  { panelAgentId: 'premium-linguist-es', displayName: 'Spanish Language Agent', displayLevel: 3, department: 'i18n', responsibility: 'Validare operațională ES', escalation: 'L2', turnAgentId: 'premium-linguist-es', sourceId: 'premium-linguist-es', telemetrySource: 'Operational Linguistic Baseline V1 · typed API state · 1.726 resurse' },
  { panelAgentId: 'premium-linguist-sv', displayName: 'Swedish Language Agent', displayLevel: 3, department: 'i18n', responsibility: 'Validare operațională SV', escalation: 'L2', turnAgentId: 'premium-linguist-sv', sourceId: 'premium-linguist-sv', telemetrySource: 'Operational Linguistic Baseline V1 · typed API state · 1.726 resurse' },
...
export function buildBasicAgentNetworkModel(dashboard = basicAgentOperationalDashboard): BasicAgentNetworkNode[] {
  ...
  return agentGovernanceRegistry
    .filter((record) => !premiumGovernanceAgentIds.has(record.id))
    .map((record) => {
