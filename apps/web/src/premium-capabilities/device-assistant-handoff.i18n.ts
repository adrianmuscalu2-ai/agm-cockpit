...
export type DeviceAssistantCopy = {
  ...
  navigation: string; dial: string; app: string; reminder: string; alarm: string; calendar: string; share: string; emailDraft: string; driverMode: string;
...
const en: DeviceAssistantCopy = {
  ...
  calendar: 'Prepare calendar event', share: 'Share through Android', emailDraft: 'Prepare email draft', driverMode: 'DRIVER VOICE MODE: short commands use the active Gmail context.',
...
const ro: DeviceAssistantCopy = {
  ...
  calendar: 'Pregateste eveniment in calendar', share: 'Distribuie prin Android', emailDraft: 'Pregateste draft e-mail', driverMode: 'DRIVER VOICE MODE: comenzile scurte folosesc contextul Gmail activ.',
...
const de: DeviceAssistantCopy = {
  ...
  calendar: 'Kalendereintrag vorbereiten', share: 'Uber Android teilen', emailDraft: 'E-Mail-Entwurf vorbereiten', driverMode: 'DRIVER VOICE MODE: Kurze Befehle verwenden den aktiven Gmail-Kontext.',
