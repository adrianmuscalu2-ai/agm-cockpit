...
assert.match(overviewRuntimeSource, /renderBasicAgentPlanetarySystem/);
assert.match(overviewRuntimeSource, /data-basic-agent-planetary-node/);
assert.match(overviewRuntimeSource, /data-basic-agent-planetary-core/);
assert.match(overviewRuntimeSource, /aggregateBasicAgentStatus/);
assert.match(overviewRuntimeSource, /nu se fabrică agenți BASIC din registry/);
