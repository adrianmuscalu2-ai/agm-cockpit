...
const premiumRuntimeSource = await readFile(resolve('src/premium-governance/premium-governance.runtime.ts'), 'utf8');
...
assert.match(turnViewSource, /data-global-agent-planetary-panel/);
assert.match(turnViewSource, /data-global-agent-planetary-stage/);
assert.match(turnViewSource, /data-global-agent-planetary-criteria/);
assert.match(turnViewSource, /Starea generală este în centru/);
assert.match(premiumRuntimeSource, /renderGlobalAgentPlanetaryModel/);
assert.match(premiumRuntimeSource, /data-global-agent-planetary-node/);
assert.match(premiumRuntimeSource, /data-global-agent-planetary-core/);
assert.match(premiumRuntimeSource, /aggregateCriterionStatus/);
assert.match(premiumRuntimeSource, /Nu se construiesc agenți din registry/);
