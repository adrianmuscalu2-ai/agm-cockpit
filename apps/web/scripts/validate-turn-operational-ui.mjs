...
for (const required of ['data-premium-spatial-stage', 'data-premium-operational-orbit', 'data-premium-orbital-stage', 'data-turn-page="premium"', 'data-turn-page="investigate"']) {
  if (!view.includes(required)) throw new Error(`TURN_SPATIAL_UI_MISSING:${required}`);
}
for (const required of ['data-premium-spatial-node', 'data-premium-orbital-node', 'data-orbital-runtime-presence', 'data-orbital-evidence-source', 'incidentQualification', 'rootCauseClassification', 'pipeline.eventStore']) {
