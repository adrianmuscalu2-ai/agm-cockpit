...
const runtimeSnapshot: AgentRuntimeAccountabilitySnapshot = {
  ...
  agents: [{
    ...
    executionEventId: 'runtime-secondary',
    ...
    validationEvidenceRef: 'AuthorityAuditJournal:secondary', lastValidation: new Date().toISOString(), freshness: 'CURRENT', freshnessWindowSeconds: 90, status: 'ACTIVE', statusSource: 'IDENTITY_MANDATE_EXECUTION_EVIDENCE_VALIDATION_ENGINE',
