...
export const premiumNetworkSeed: readonly PremiumNetworkSeed[] = [
  ...
  entry({ canonicalId: 'premium.car-mover.route-mobility', kind: 'AGENT', module: 'car-mover', ownerId: 'premium.orchestrator', scope: 'premium.car-mover.route', writePermissions: ['opportunity.route.assess'], capabilities: ['route-analysis'], allowedProviders: modelProviders, fallbackProviders: ['rules-engine'] }),
  entry({ canonicalId: 'premium.car-mover.cost-risk', kind: 'AGENT', module: 'car-mover', ownerId: 'premium.orchestrator', scope: 'premium.car-mover.cost-risk', writePermissions: ['opportunity.cost.assess'], capabilities: ['cost-risk-analysis'], allowedProviders: modelProviders, fallbackProviders: ['rules-engine'] }),
  ...
  entry({ canonicalId: 'premium.adapters.geocoding', kind: 'SERVICE', module: 'live-mobility', ownerId: 'premium.car-mover.route-mobility', scope: 'premium.car-mover.adapters.geocoding', readPermissions: ['external.location.read'], capabilities: ['geocoding-normalization'], allowedProviders: ['tomtom'], fallbackProviders: ['here','manual'] }),
  entry({ canonicalId: 'premium.adapters.routing', kind: 'SERVICE', module: 'live-mobility', ownerId: 'premium.car-mover.route-mobility', scope: 'premium.car-mover.adapters.routing', readPermissions: ['external.route.read'], capabilities: ['route-normalization'], allowedProviders: ['tomtom'], fallbackProviders: ['here','cache','manual'] }),
  ...
  entry({ canonicalId: 'premium.adapters.toll', kind: 'SERVICE', module: 'live-mobility', ownerId: 'premium.car-mover.cost-risk', scope: 'premium.car-mover.adapters.toll', readPermissions: ['external.toll.read'], capabilities: ['toll-normalization'], allowedProviders: ['tollguru'], fallbackProviders: ['here','cache','manual'] }),
  entry({ canonicalId: 'premium.adapters.transit', kind: 'SERVICE', module: 'live-mobility', ownerId: 'premium.car-mover.route-mobility', scope: 'premium.car-mover.adapters.transit', readPermissions: ['external.transit.read'], capabilities: ['transit-normalization','intermodal-normalization'], allowedProviders: ['here'], fallbackProviders: ['db-timetables','cache','manual'] }),
