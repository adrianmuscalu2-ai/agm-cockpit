...
export const vehicleClasses = ['PASSENGER_CAR','LIGHT_COMMERCIAL','VAN','CAR_WITH_TRAILER','TRANSPORTER','TRUCK','TRACTOR_UNIT','OTHER_DRIVABLE_VEHICLE'] as const;
export type VehicleClass = typeof vehicleClasses[number];

export const routingVehicleClasses = [...vehicleClasses, 'UNKNOWN'] as const;
export type RoutingVehicleClass = typeof routingVehicleClasses[number];
export const DEFAULT_CAR_MOVER_PROFILE: VehicleClass = 'PASSENGER_CAR';
