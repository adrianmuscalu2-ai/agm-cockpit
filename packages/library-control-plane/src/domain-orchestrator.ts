...
const BASIC_SOURCES = new Set<AgmLibrarySourceId>([
  'CONVERSATION_HISTORY', 'PREVIOUS_TRANSLATIONS', 'OCR_ARCHIVE', 'AGM_CANONICAL_LIBRARY', 'PROFILE_PERMITTED_DATA', 'AGM_SHARED_ARCHIVE',
]);
...
const CAR_MOVER_SOURCES = new Set<AgmLibrarySourceId>([
  ...
  'GMAIL', 'AGM_SHARED_ARCHIVE', 'PROFILE_PERMITTED_DATA',
]);
